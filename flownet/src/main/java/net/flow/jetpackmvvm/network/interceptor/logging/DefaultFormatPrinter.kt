package net.flow.jetpackmvvm.network.interceptor.logging

import android.text.TextUtils
import net.flow.jetpackmvvm.network.interceptor.logging.LogInterceptor.Companion.isJson
import net.flow.jetpackmvvm.network.interceptor.logging.LogInterceptor.Companion.isXml
import net.flow.jetpackmvvm.util.CharacterHandler.Companion.jsonFormat
import net.flow.jetpackmvvm.util.CharacterHandler.Companion.xmlFormat
import net.flow.jetpackmvvm.util.LogUtils
